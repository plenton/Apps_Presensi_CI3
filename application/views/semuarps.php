...
<table class="table">
    ...
    <tr>
        ...
        <td><a class= "btn btn-danger" href="<?php echo base_url('/rps/iprint') ?>/<?php echo $isi->kode_matkul; ?>"><i class="fa fa-print"></i> Print</a></td>
        ...
        <td><?php echo $isi->materi_per1 ?></td>
        <td><?php echo $isi->materi_per2 ?></td>
        <td><?php echo $isi->materi_per3 ?></td>
        <td><?php echo $isi->materi_per4 ?></td>
        <td><?php echo $isi->materi_per5 ?></td>
        <td><?php echo $isi->materi_per6 ?></td>
        <td><?php echo $isi->materi_per7 ?></td>
        <td><?php echo $isi->materi_per8 ?></td>
        <td><?php echo $isi->materi_per9 ?></td>
        <td><?php echo $isi->materi_per10 ?></td>
        <td><?php echo $isi->materi_per11 ?></td>
        <td><?php echo $isi->materi_per12 ?></td>
        <td><?php echo $isi->materi_per13 ?></td>
        <td><?php echo $isi->materi_per14 ?></td>
    </tr>
